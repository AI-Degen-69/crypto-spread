...
description: Development conventions and patterns for crypto-spread. Python project with conventional commits.
---
...
```text
feat: tick capture + backtest lab — full-depth CLOB + tape replay
```
