...
pip install pytest                          # dev: 71 tests
...
- `tests/` — 71 tests: `test_backtest_engine.py` (41), `test_backtest_index.py` (5), `test_collect_ticks_smoke.py` (8), `test_rebuild_windows.py` (4), `test_osc_dash_integration.py` (13).
