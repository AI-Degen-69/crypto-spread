...
pip install pytest                          # dev: 87 tests
...
- `tests/` — 87 tests: `test_backtest_engine.py` (41), `test_backtest_index.py` (5), `test_collect_ticks_smoke.py` (8), `test_rebuild_windows.py` (4), `test_verify_tick_data.py` (14), `test_osc_dash_integration.py` (14), `test_docstrings.py` (1).
