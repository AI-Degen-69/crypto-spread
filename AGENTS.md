...
- `tests/` — 186 tests across 13 test files: `test_backtest_engine.py` (48), `test_live_trader.py` (34), `test_osc_dash_integration.py` (23), `test_verify_tick_data.py` (14), `test_orders_trades_table.py` (8), `test_sweep_backtest.py` (8), `test_collect_ticks_smoke.py` (8), `test_series.py` (9), `test_streaming.py` (9), `test_live_trader_streaming.py` (7), `test_backtest_index.py` (5), `test_rebuild_windows.py` (4), `test_docstrings.py` (1).
