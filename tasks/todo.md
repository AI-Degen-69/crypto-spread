...
- [ ] Task 2: Queue panel UI — bars, verdict, empty state, fallback (`server/osc_dash.py`)
- [ ] Task 3: PnL histogram UI — binning, zero bin, mean + CI-lo, fallback (`server/osc_dash.py`)
