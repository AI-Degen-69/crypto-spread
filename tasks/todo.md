...
- [x] **T3** `[Backend/Logic]` Live: delete timeout/start knobs, add Dead Zone & `naked_leg_at_expiry`
- [x] **T4** `[Test/Parity]` `tests/test_dead_zone_parity.py` — entry blocked, orders cancelled, close vs hold
- [x] **T5** `[API/Dashboard]` Update API schemas, parameter registry, and Cockpit/Backtest UI controls
